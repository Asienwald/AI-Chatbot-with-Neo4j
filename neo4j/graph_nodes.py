...
walk_relations = [
    ...
    Relationship(facilities_nodes["sa"], "WALK", food_nodes["fc5"]),
    Relationship(facilities_nodes["sac"], "WALK", facilities_nodes["sa"]),
    Relationship(facilities_nodes["sac"], "WALK", facilities_nodes["polyc"]),
    Relationship(building_nodes["t10"], "WALK", facilities_nodes["polyc"]),
    Relationship(facilities_nodes["sanc"], "WALK", building_nodes["t10"]),
    Relationship(facilities_nodes["moberly"], "WALK", building_nodes["t10"]),
    Relationship(building_nodes["t7"], "WALK", facilities_nodes["sanc"]),
    Relationship(building_nodes["t9"], "WALK", facilities_nodes["sanc"]),
    Relationship(building_nodes["t8"], "WALK", building_nodes["t9"]),
    Relationship(building_nodes["t6"], "WALK", building_nodes["t9"]),
    Relationship(facilities_nodes["mainlib"], "WALK", building_nodes["t6"]),
    Relationship(facilities_nodes["colours"], "WALK", facilities_nodes["sanc"]),
    Relationship(facilities_nodes["admin"], "WALK", facilities_nodes["colours"]),
    Relationship(facilities_nodes["spav"], "WALK", facilities_nodes["colours"]),
    Relationship(building_nodes["t4"], "WALK", facilities_nodes["spav"]),
    Relationship(building_nodes["t4a"], "WALK", building_nodes["t4"]),
    Relationship(building_nodes["t3"], "WALK", building_nodes["t5"]),
    Relationship(building_nodes["t3a"], "WALK", building_nodes["t3"]),
    Relationship(building_nodes["w4"], "WALK", building_nodes["t3a"]),
    Relationship(building_nodes["w5a"], "WALK", building_nodes["w5"]),
    Relationship(facilities_nodes["mpf"], "WALK", facilities_nodes["sa"]),
    Relationship(building_nodes["t2"], "WALK", building_nodes["t3"]),
    Relationship(food_nodes["fc1"], "WALK", building_nodes["t3a"]),
    Relationship(building_nodes["t2"], "WALK", building_nodes["t1"]),
    Relationship(building_nodes["w3"], "WALK", building_nodes["t1"]),
    Relationship(building_nodes["w2"], "WALK", building_nodes["w3"]),
    Relationship(building_nodes["w1"], "WALK", building_nodes["w2"]),
    Relationship(building_nodes["t1ac"], "WALK", building_nodes["t1"]),
    Relationship(building_nodes["isc"], "WALK", building_nodes["t1ac"])
]
